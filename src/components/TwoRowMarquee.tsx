...
export const TwoRowMarquee: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  return (
    <div className={`w-full overflow-hidden relative py-4 my-6 select-none ${className}`}>
      ...
      <div className="flex flex-col gap-4 md:gap-5">
        ...
        <div className="w-full overflow-hidden flex">
          <div className="flex gap-4 md:gap-5 shrink-0 animate-marquee-left">
            {row1List.map((src, idx) => (
              <div
                key={`r1-${idx}`}
                className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-sm w-[260px] sm:w-[320px] md:w-[380px] aspect-[16/9] shrink-0 bg-neutral-100 group"
              >
                <img
                  src={src}
        ...
        {/* Row 2 — Scroll Right */}
        <div className="w-full overflow-hidden flex">
          <div className="flex gap-4 md:gap-5 shrink-0 animate-marquee-right">
